# working directory: Locuszooms github

## UCSC gene-track export - 27-02-17
UCSC_GRCh37_Genes <- read.delim("making_genelists/UCSC_GRCh37_Genes.txt", stringsAsFactors = FALSE)
  # original: UCSC_GRCh37_Genes <- read.delim("~/GitHub/LocusZooms/UCSC_GRCh37_Genes.txt", stringsAsFactors=FALSE)
